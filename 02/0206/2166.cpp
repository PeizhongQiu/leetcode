 ...
 * [2166] 设计位集
 *
 * https://leetcode-cn.com/problems/design-bitset/description/
 *
 * algorithms
 * Medium (27.83%)
 * Likes:    18
...
public:
    ...
    void flip() {
        isFlip = !isFlip;
        oneNum = data.size() - oneNum;
    }
    
    bool all() {
        return oneNum == data.size();
    }
